...
import { cleanParams, cn, formatEnumString } from "@/app/lib/utils";
import { Input } from "@/components/ui/input";
import { Button } from "@/components/ui/button";
import { Search } from "lucide-react";
import { AmenityIcons, PropertyTypeIcons } from "@/app/lib/constants";
...
const FiltersFull = () => {
  ...
  return (
    <div className="bg-white text-black rounded-lg px-4 py-4 h-full overflow-auto pb-10">
      <div className="flex flex-col space-y-6">
        ...
        <div>
          ...
          <div className="flex items-center">
            ...
            <Button
              ...
              className="rounded-r-xl rounded-l-none border-l-none border-black shadow-none border hover:bg-gray-700 hover:text-gray-50"
            >
          ...
          <div className="grid grid-cols-2 gap-4">
            {Object.entries(PropertyTypeIcons).map(([type, Icon]) => (
              <div
                key={type}
                className={cn(
                  "flex flex-col items-center text-gray-600 justify-center p-4 border rounded-xl cursor-pointer",
        ...
        <div className="flex gap-4 mt-6">
          <Button
            ...
            className="flex-1 bg-gray-700 text-white rounded-xl"
          >
            APPLY
          </Button>
          <Button
