...
import { Lease, Payment, Property } from "@/app/types/prismaTypes";
import {
  ArrowDownToLineIcon,
  Check,
  CreditCard,
...
const Residence = () => {
  ...
  // Find the lease that matches the current property
  const currentLease = leases?.find(
    (lease) => lease.propertyId === Number(id)
  );

  // Fetch payments for the current lease (not the first lease in the array)
