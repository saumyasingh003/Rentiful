      ...
      <div className="flex justify-between items-center w-full py-3 px-8 bg-black text-white">
        <div className="flex items-center gap-4 md:gap-6">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="text-xl font-bold">
                RENT
                <span className="text-[#BF5B4D] font-semibold hover:!text-gray-300">
                  IFUL
                </span>
              </div>
            </div>
          ...
          {isDashboardPage && authUser && (
            <Button
              variant="secondary"
              className="md:ml-4 bg-gray-50 text-gray-700 hover:bg-gray-100 hover:text-gray-500"
              onClick={() =>
                router.push(
          ...
          {authUser ? (
            <>
              <div className="relative hidden md:block">
                ...
                <span className="absolute top-0 right-0 w-2 h-2 bg-[#BF5B4D] rounded-full"></span>
              </div>
              <div className="relative hidden md:block">
                ...
                <DropdownMenuTrigger className="flex items-center gap-2 focus:outline-none">
                  ...
                  <p className="text-gray-200 hidden md:block">
                    {authUser.userInfo?.name
                      ...
                      authUser.userInfo.name.slice(1)
                      : ""}
                  </p>
            ...
            <>
              ...
              <Link href="/signup">
                <Button
                  variant="secondary"
                  className="text-white bg-[#BF5B4D] hover:bg-white hover:text-gray-700 rounded-lg"
                >
                  Sign Up
                </Button>
              </Link>
